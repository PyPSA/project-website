...
<footer id="footer" class="container py-24 pb-16 sm:py-32 sm:pb-24">
  <div class="p-10 bg-muted/50 dark:bg-card border rounded-2xl">
    <div class="flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <div class="flex flex-col items-center md:items-start">
        ...
        <p class="text-muted-foreground text-center md:text-left max-w-md">
          Python for Power System Analysis - An open framework for simulating and optimising modern
      ...
      <div class="flex flex-col items-center md:items-end gap-4">
        <div class="flex items-center gap-4">
          ...
          <a
            href="https://www.youtube.com/@pypsa-official"
            target="_blank"
            rel="noreferrer"
            class="opacity-60 hover:opacity-100 transition-opacity"
            aria-label="YouTube"
    ...
    <div
      class="flex flex-col md:flex-row justify-between items-center gap-4 text-muted-foreground text-sm"
    >
      <div class="text-center md:text-left">
        ...
        <p>
          ...
          <a href="mailto:contact@pypsa.org" class="hover:text-primary transition-colors"
            >contact@pypsa.org</a
          >
        </p>
      </div>
